...
public class SituatieVanzariController implements Initializable {
	...
	public void initializareTable() {
		...
		totalVanzari.setText("TOTAL VANZARI: "+df.format(TOTAL_VANZARI));
